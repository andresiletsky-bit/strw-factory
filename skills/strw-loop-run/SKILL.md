...
- До Andrii йде ТІЛЬКИ: gate-рішення (G1–G4), дії зі списку company-context.md принцип 5 (єдине джерело), і genuine `question` — петля дійсно не може вирішити сама (конфлікт, брак даних, портфельна колізія).
