...
expect: FAIL
level: 0
defect: email у YAML-блоці: персона є агрегатом сегмента, не профілем конкретної людини (data-policy P7)
defect_keywords: [PII, email]
source: golden persona-card сіді-кейс 4
---
...
demographics:
  ...
  contact: "[A] tea.collector@example.com"
