...
expect: FAIL
level: 0
defect: unexpected_trait без тегу [E]: анти-каррикатура, придумана моделлю, каррикатурою і лишається
defect_keywords: [unexpected_trait, [E], джерел]
source: golden persona-card сіді-кейс 1
---
...
unexpected_trait: "веде паперовий журнал поруч із цифровим"
