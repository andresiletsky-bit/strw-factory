...
expect: FAIL
level: 1
defect: карта p2 — набір поколіннєвих стереотипів: unexpected_trait не контрстереотипна, а підсилює стереотип
defect_keywords: [каррикатур, стереотип, unexpected_trait]
source: golden persona-card сіді-кейс 6
---
...
values_culture: "[A] естетика > глибина, як у всього покоління"
unexpected_trait: "[E] як усі зумери, скролить TikTok і хоче все й одразу (r/tea beginner-тред, 2026-05, довіра: середня)"
