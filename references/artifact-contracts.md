...
Обов'язково: Що реалізовано vs PRD (diff scope) · Статус тестів (лінк на CI) · Tracking plan покриття · Відомі обмеження · Чеклист deploy-checklist пройдено · Code-review вердикт checker'а.

## launch-checklist.md (стадія QA & Launch)
Обов'язково: тести пройдені · аналітика верифікована на staging · rollback-план · сторінка продукту · ціни.
...
Обов'язково: Стан кожного продукту (стадія, ключова метрика, тренд) · Метрики фабрики (throughput, kill-rate, autonomy ratio, inbox lag, budget факт) · 1–3 фокуси наступного тижня · Кандидати на KILL/подвійну ставку · Питання, що чекають рішення в inbox.
