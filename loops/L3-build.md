...
stop_condition: "/goal-умова циклу: тести зелені + lint чистий + tracking events реалізовані; стадії: build-report + launch-checklist за контрактами → gate-request G3"
...
budget: maker/checker — opus; ≤2 паралельні worktree на продукт; /goal-сесії групувати (1–2/день на продукт max)
