...
Специфіка цього чекера всередині формату: кожна знахідка несе конкретну заміну before/after, а детермінованою дією є прогін `bin/copy-lint.py` із цитуванням його чисел. Максимум 2 ітерації; далі розбіжність — в inbox разом із чернеткою.
