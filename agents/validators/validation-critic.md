...
Специфіка: кожне заперечення посилається на пункт перевірки вище. Максимум 2 ітерації виправлень maker'ом; далі — розбіжність фіксується в артефакті (розділ critic-review), рішення за Andrii.
